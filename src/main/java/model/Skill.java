...
//@formatter:off
   ...
   * @return 스킬 사용 결과
   */
  public SkillResult useSkill(GameCharacter caster, Monster target) {
  ...
  private SkillResult useAttackSkill(GameCharacter caster, Monster target) {
  ...
  private SkillResult useHealSkill(GameCharacter caster) {
  ...
  private SkillResult useBuffSkill(GameCharacter caster) {
