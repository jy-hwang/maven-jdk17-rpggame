...
public class BattleController {
   ...
   */
  public BattleResult startBattle(GameCharacter player, Monster monster) {
    try {
      System.out.println("\n⚔️ 전투 시작!");
   ...
   * 플레이어 공격을 처리합니다.
   */
  private void handlePlayerAttack(GameCharacter player, Monster monster) {
   ...
   * 전투 중 스킬을 사용합니다.
   */
  private boolean useSkillInBattle(GameCharacter player, Monster monster) {
   ...
   * 전투 중 아이템을 사용합니다.
   */
  private boolean useItemInBattle(GameCharacter player) {
   ...
   * 승리를 처리합니다.
   */
  private void handleVictory(GameCharacter player, Monster monster) {
    try {
      System.out.println("\n🏆 승리!");
