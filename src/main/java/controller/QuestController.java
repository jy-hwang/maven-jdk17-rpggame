...
public class QuestController {
  ...
  public QuestController(QuestManager questManager, GameDataService.GameState gameState) {
   ...
   */
  public void manageQuests(GameCharacter player) {
    while (true) {
      displayQuestMenu();
   ...
   */
  private void acceptQuest(GameCharacter player) {
   ...
   * 퀘스트 보상을 수령합니다.
   */
  private void claimQuestReward(GameCharacter player) {
   ...
   * 퀘스트 통계를 표시합니다.
   */
  private void displayQuestStatistics(GameCharacter player) {
   ...
   */
  public void updateCollectionProgress(GameCharacter player, String itemName, int quantity) {
   ...
   * @param player 플레이어 캐릭터
   */
  public void updateLevelProgress(GameCharacter player) {
   ...
   * 퀘스트 힌트를 표시합니다.
   */
  public void showQuestHints(GameCharacter player) {
