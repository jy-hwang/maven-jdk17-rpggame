...
import rpg.shared.dto.player.SkillCooldownDto;
import rpg.shared.dto.player.SkillDto;
import rpg.shared.dto.player.SkillManagerDto;
...
public class SkillManagerMapper {
   ...
   */
  public static SkillManagerDto toDto(SkillService skillManager) {
   ...
   */
  public static SkillService fromDto(SkillManagerDto dto) {
    if (dto == null) {
   ...
   * 스킬 매니저 통계 출력 (디버그용)
   */
  public static void printSkillManagerStats(SkillService skillManager) {
    if (skillManager == null) {
