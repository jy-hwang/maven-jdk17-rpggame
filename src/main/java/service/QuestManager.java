...
public class QuestManager {
   ...
   * 플레이어의 퀘스트 완료률 계산
   */
  public double getCompletionRate(GameCharacter character) {
   ...
   * 일일 퀘스트 생성 (확장 기능)
   */
  public void generateDailyQuests(GameCharacter character) {
   ...
   * 퀘스트 보상 미리보기
   */
  public void previewQuestRewards(GameCharacter character) {
    List<Quest> available = getAvailableQuests(character);
